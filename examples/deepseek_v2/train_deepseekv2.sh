...
MODEL_NAME=DeepSeek-V2-23B

# DATA_DIR="/workspace/data"
MODEL=deepseek-ai/${MODEL_NAME}

MODEL_SIZE="${MODEL_SIZE:-24B}"
BATCH_SIZE=4
MBS="${MBS:-4}"
GBS="${GBS:-256}"
LR=1e-5
...
SAVE_INTERVAL=5000
DATASET_PATH=./examples/deepseek_v2/deepseek-datasets/mmap_deepseekv2_datasets_text_document
VALID_DATASET_PATH=./examples/deepseek_v2/deepseek-datasets/mmap_deepseekv2_datasets_text_document
...
NAME="pretrain-mcore-deepseek-${MODEL_SIZE}-lr-${LR}-bs-${MBS}-seqlen-${SEQ_LEN}-pr-${PR}-tp-${TP}-pp-${PP}-ac-${AC}-do-${DO}-sp-${SP}"
